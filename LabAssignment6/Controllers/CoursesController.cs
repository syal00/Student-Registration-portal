...
namespace LabAssignment6.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            // Automatically delete all associated AcademicRecords first
            if (course.AcademicRecords != null && course.AcademicRecords.Any())
            {
                _context.AcademicRecords.RemoveRange(course.AcademicRecords);
            }
